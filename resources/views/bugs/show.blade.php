                ...
                <div class="bg-purple-800 rounded-md overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        ...
                        <div class="flex  justify-end mt-6">
                            <div class="col-span-1 font-bold text-center mr-2">
                                <a class="inline-block px-4 py-2 bg-yellow-500 text-white rounded hover:bg-blue-600" href="{{ route('bugs.edit', $detalle_bug) }}">
                            ...
                            <div class="col-span-1 font-bold text-center ml-2">
                                <form class="inline-block" action="{{ route('bugs.destroy', $detalle_bug) }}" method="POST">
                                    @method("DELETE")
                                    @csrf
                                    <button type="submit" class="bg-red-500 text-white px-3 py-2 rounded hover:bg-blue-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
