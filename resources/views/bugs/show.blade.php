                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <p class="text-green-500">{{ $detalle_bug->codigo }}</p>
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="flex  justify-end mt-6">
                            <div class="col-span-1 font-bold text-center mr-2">
                                <a class="inline-block px-4 py-2 bg-yellow-500 text-white rounded hover:bg-purple-600" href="{{ route('bugs.edit', $detalle_bug) }}">
