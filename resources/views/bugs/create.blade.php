    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <form action="{{ route('bugs.store') }}" method="post" class="flex flex-col space-y-4">
                @csrf
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <input type="text" name="codigo" id="codigo" class="py-2 px-3 border bg-gray-200 rounded-md border-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500">
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <input type="text" name="plataforma" id="plataforma" class="py-2 px-3 border bg-gray-200 rounded-md border-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500">
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <select name="asignatura" id="asignatura" class="py-2 px-3 border bg-gray-200 rounded-md border-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500">
