<div class="mt-6 flex justify-end w-12/12">
    <a class="inline-block px-4 py-2 bg-blue-500 hover:bg-green-700 text-white font-bold rounded focus:outline-none focus:shadow-outline" href="{{ route('cornellnotes.create') }}">
